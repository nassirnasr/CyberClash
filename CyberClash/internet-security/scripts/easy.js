...
function compareCards() {
    ...
    if (playerLife <= 0) {
        ...
        setTimeout(playTurn, 2000); // Adjust the delay as needed
    }
...
function gameOver(winner) {
    ...
    document.getElementById("playerScore").innerHTML = playerLife;
    document.getElementById("hackerScore").innerHTML = hackerLife;
}
